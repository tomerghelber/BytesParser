...
import org.bits.bytesparser.parsers.NumberParser;
...
import static org.bits.bytesparser.parsers.json.JsonListParser.LIST_START;
import static org.bits.bytesparser.parsers.json.JsonMapParser.MAP_START;
import static org.bits.bytesparser.parsers.json.JsonStringParser.STRING_START;
...
public class JsonParser implements Parser<BitArray, Object> {
    ...
    public static char peekChar(Context<BitArray> context) {
        return (char) context.peekData(Byte.SIZE).toBytes()[0];
    }

    private static byte getByte(Context<BitArray> context) {
        return context.getData(Byte.SIZE).toBytes()[0];
    }
